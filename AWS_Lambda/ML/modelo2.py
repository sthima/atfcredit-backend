...
# docker tag modelo2:latest 385901034746.dkr.ecr.sa-east-1.amazonaws.com/modelo1:latest
        
# docker push 385901034746.dkr.ecr.sa-east-1.amazonaws.com/modelo1:latest

# aws ecr get-login-password | docker login --username AWS --password-stdin 385901034746.dkr.ecr.sa-east-1.amazonaws.com/modelo1:latest