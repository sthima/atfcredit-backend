...
class ClearData():
    def __init__(self, df):
        try:
            df = df.sort_values(by=['data_consulta'], ascending= False).reset_index(drop = True)
        except:
            pass
        ...
        self.serasa_columns = ['10_FREQUENCIA_PROTESTO', '10_MEDIA_VALOR', '10_STD_VALOR',
                               ...
                               'HISTORICO DE PAGAMENTOS NO MERCADO', 'PEFIN', 'PROTESTO', 'REFIN', 'classificacao', 'cnpj', 'predicao', 'resultado']
    ...
    def clear_df(self):
        ...
        df = df.merge(self.origin_df[['cnpj','resultado']], how = 'left')
        return df