...
class BuisinessReferencesMarket(TextInterpreter):
    def create_df(self, text, name_type):
        ...
        line_aux, table_columns, table_name = self._default_search(text= text,table_columns = table_columns,table_vector = table_vector,split_line = split_line,split_space = split_space)
